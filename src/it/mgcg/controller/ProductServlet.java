...
import it.mgcg.beans.ResponseStatusMessage;
import it.mgcg.beans.Product;
import it.mgcg.beans.Review;
import it.mgcg.beans.User;
import it.mgcg.model.ProductDAO;
import it.mgcg.model.ReviewDAO;
...
public class ProductServlet extends HttpServlet {
	...
	private void index(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			for (Product p : products) { // unica attenzione a il nome del' immagine deve essere lo stesso id (es: prodotto 18 ha come immagine "18.jpg" )
