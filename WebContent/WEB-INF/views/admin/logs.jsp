...
<z:layout pageTitle="Admin Control Panel">
	...
	<div>
		<a href="<c:url value="/Admin/Orders"/>">Gestisci gli ordini</a><br>
		<a href="<c:url value="/Admin/Products"/>">Gestisci i prodotti</a><br>
	...
	<h1 class="is-size-4 mb-2">Elenco registri</h1>
